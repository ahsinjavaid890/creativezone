...
@section('title','All Photo Categories')
@section('content')
                ...
                <div class="card-header flex-wrap">
                    <div class="card-title">
                        <h3 class="card-label">
                            ...
                            <div class="text-muted pt-2 font-size-sm">Manage All Photo Categories</div>
                        </h3>
                    </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p style="color:red;">Are you Sure You want to delete this. If you Delete this Category then All Vedio will be deleted Automaticaly against this Category</p>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-light-primary font-weight-bold" data-dismiss="modal">Close</button>
                                            <a href="{{ url('admin/photo/deletephotocategory') }}/{{ $r->id }}" class="btn btn-danger font-weight-bold">Yes, Delete it</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="modal fade" id="categoryedit{{ $r->id }}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form enctype="multipart/form-data" method="POST" action="{{ url('admin/photo/updatphotocategory') }}">
                                            @csrf
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="10" class="summernote" name="categorie_description">{{ $r->categorie_description }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control " name="status"> 
                                                                ...
                                                                <option @if($r->status == 0) selected @endif value="0">Not Published</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
...
<div class="modal fade" id="exampleModalScrollable" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data" method="POST" action="{{ url('admin/photo/addnewphotocategory') }}">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="lable-control">Enter Description</label>
                                <textarea rows="10" class="summernote" name="categorie_description"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
