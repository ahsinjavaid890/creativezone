                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
                    ...
                    <div class="navi navi-spacer-x-0 pt-5">
                        ...
                        <div class="navi-footer  px-8 py-5">
                            <a href="{{ route('admin.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" role="button"  class="btn btn-light-primary font-weight-bold">Sign Out</a>
