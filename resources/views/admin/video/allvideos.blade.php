            ...
            <div class="card card-custom mt-5">
                <div class="card-header flex-wrap">
                    <div class="card-title">
                        <h3 class="card-label">
                            All Video
                            <div class="text-muted pt-2 font-size-sm">Manage All Video</div>
                        </h3>
                    </div>
                    <div class="card-toolbar">
                        ...
                        <a href="javascript::void(0)" class="btn btn-primary font-weight-bolder" data-toggle="modal" data-target="#exampleModalScrollable">
                            <span class="svg-icon svg-icon-md">
                                ...
                                <!--end::Svg Icon--></span> Add New Video
                        </a>
                        <!--end::Button-->
                    </div>
                </div> 
                            ...
                            <tr>
                                <td>
                                    <video width="150" height="100" controls>
                                      ...
                                      <source src="{{ url('public/images') }}/{{ $r->video }}" type="video/ogg">
                                    </video>
                                </td>
                                <td>
                                    {{ $r->name }}
                                ...
                                <td>
                                    {{ DB::table('videocategories')->where('id' , $r->category_id)->first()->name }}
                                </td>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ url('admin/video/deletevideo') }}/{{ $r->id }}" class="btn btn-danger font-weight-bold">Yes, Delete it</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="modal fade" id="categoryedit{{ $r->id }}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form enctype="multipart/form-data" method="POST" action="{{ url('admin/video/updatvideo') }}">
                                            @csrf
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="lable-control">Select Video</label>
                                                            <input name="video"  type="file" id="emailfield" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="lable-control">Video Order</label>
...
<div class="modal fade" id="exampleModalScrollable" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data" method="POST" action="{{ url('admin/video/addnewvideo') }}">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="lable-control">Select Video</label>
                                <input name="video" required type="file" id="emailfield" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="row">
