                ...
                <div class="card-header flex-wrap">
                    <div class="card-title">
                        <h3 class="card-label">
                            ...
                            <div class="text-muted pt-2 font-size-sm">Manage All Video Categories</div>
                        </h3>
                    </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ url('admin/video/deletevideocategory') }}/{{ $r->id }}" class="btn btn-danger font-weight-bold">Yes, Delete it</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="modal fade" id="categoryedit{{ $r->id }}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form enctype="multipart/form-data" method="POST" action="{{ url('admin/video/updatvideocategory') }}">
                                            @csrf
...
<div class="modal fade" id="exampleModalScrollable" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data" method="POST" action="{{ url('admin/video/addnewvideocategory') }}">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
