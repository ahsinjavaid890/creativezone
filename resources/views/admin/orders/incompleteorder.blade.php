...
@section('title','Incomplete orders | Orders')
@section('content')
 <!--begin::Content-->
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class=" container-fluid ">
            ...
            <div class="card card-custom mt-5">
                <div class="card-body">
                    <form id="filterForm" method="GET" action="{{ url('admin/orders/followuporder') }}">
                        <div class="row">
                            <div class="col-md-2">
            ...
            <div class="card card-custom mt-5">
                ...
                <div class="card-body" id="table-data">
                    @include('admin.orders.render.followorder_table', ['data' => $data])
                </div>
            </div>
            <!--end::Card-->
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        function fetchorder() {
            ...
            $.ajax({
                url: "{{ url('admin/orders/followuporder') }}",
                type: "GET",
                data: formData,
                success: function (data) {
                    $('#table-data').html(data.tableData);
                    let newUrl = "{{ url('admin/orders/followuporder') }}" + '?' + formData;
