...
@section('title','Accessories Review')
@section('content')
 <!--begin::Content-->
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <a href="{{ url('admin/ecommerce/editproduct') }}/{{ $data->id }}" class="text-dark font-weight-bold mt-2 mb-2 mr-5">
                    Accessories : <b class="text-danger">{{ $data->name }}</b>
                </a>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            @foreach($review as $r)
                                ...
                                <td class="text-center pr-0">
                                   ...
                                   <a href="javascript:void(0);" onclick='confirmDelete("{{ url('admin/ecommerce/deleteaccessoriesreview') }}/{{ $r->id }}")' class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <h5 class="modal-title" id="exampleModalLabel">Update Accessories Review</h5>
                                                </div>
                                            </div>
                                        ...
                                        <form enctype="multipart/form-data" method="POST" action="{{ url('admin/ecommerce/updateaccessoriereview') }}">
                                            @csrf
