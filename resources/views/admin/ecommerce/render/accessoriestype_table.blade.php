        ...
        @foreach($data as $r)
            <tr>
                ...
                <td class="text-center pr-0">
                    @if($r->status == 1)
                    <a href="javascript::void(0)" onclick='confirmstatus("{{ url('admin/ecommerce/changeaccessoriesstatus') }}/{{ $r->id }}")'>
                ...
                <td class="text-center pr-0">
                   ...
                   <a href="javascript::void(0)" onclick='confirmDelete("{{ url('admin/ecommerce/deleteaccesoriestype') }}/{{ $r->id }}")' class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
            ...
            <div class="modal fade" id="editaccesoriestype{{ $r->id }}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                    <div class="modal-content">
                        ...
                        <form  enctype="multipart/form-data" method="POST" action="{{ url('admin/ecommerce/updateaccesoriestype') }}">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="lable-control">Enter Type</label>
                                            <input type="text" name="type" class="form-control" placeholder="Enter Type" value="{{ $r->type }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
