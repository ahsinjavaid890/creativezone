...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-4 bg-gray-200"></div>
                <a href="{{ url('admin/ecommerce/brands') }}" class="text-blue font-weight-bold mt-2 mb-2 mr-5">
                    Brands
                </a>
                <div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-4 bg-gray-200"></div>
                <a href="javascript:void(0)" class="text-dark font-weight-bold mt-2 mb-2 mr-5">
                    Update Brand : <b class="text-danger">{{ $data->name }}</b>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class=" container-fluid ">
            ...
            <form enctype="multipart/form-data" method="POST" action="{{ url('admin/ecommerce/updatebrand') }}">
            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input required value="{{ $data->name }}" type="text" placeholder="Enter Brand Name" class="form-control" name="name">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Brand Status <span class="text-danger">*</span></label>
