        ...
        <div class=" container-fluid ">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="category_id" id="category_id" class="form-control">
                                        ...
                                        @foreach(DB::table('categories')->where('category_type' , 'accessories')->where('status' , 1)->get() as $r)
            ...
            <div class="card card-custom mt-5">
                ...
                <div class="card-body table-responsive" id="table-data">
                    @include('admin.ecommerce.render.modal_table', ['data' => $data])
                </div>
            </div>
            <!--end::Card-->
        </div>
...
<div class="modal fade" id="exampleModalCenter" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form method="POST" action="{{ url('admin/ecommerce/createmodal') }}" class="modal-content">
            @csrf
...
<script>
    ...
    function confirmstatus(url) {
        Swal.fire({
            title: 'Are you sure you Want To Change Status of This modal?',
            text: "If Status is Not Published then This modal Will not show Frontend",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
...
$(document).ready(function () {
    function fetchorder() {
        ...
        $.ajax({
            url: "{{ url('admin/ecommerce/models') }}",
            type: "GET",
            data: formData,
            success: function (data) {
                $('#table-data').html(data.tableData);
                let newUrl = "{{ url('admin/ecommerce/models') }}" + '?' + formData;
