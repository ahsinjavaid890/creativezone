...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-4 bg-gray-200"></div>
                <a href="{{ url('admin/users/allusers') }}" class="text-blue font-weight-bold mt-2 mb-2 mr-5">
                    All Users
                </a>
                <div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-4 bg-gray-200"></div>
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container-fluid">
           ...
           <form method="post" action="{{ url('admin/users/updateuser') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card card-custom mt-5">
                <div class="card-header flex-wrap">
                    <div class="card-title">
                        <h3 class="card-label">
                            Update User
                            <div class="text-muted pt-2 font-size-sm">Update User</div>
                        </h3>
                    </div>
                </div>
                <div class="card-body">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="rolls" >
                                    <option>Select Roll</option>
                                    @foreach(DB::table('rules')->get() as $r)
                                    <option @if($data->role_id == $r->id) selected @endif value="{{ $r->id }}">{{ $r->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
