            ...
            <div class="card card-custom mt-5">
                <div class="card-header flex-wrap">
                    <div class="card-title">
                        <h3 class="card-label">
                            All Tags
                            <div class="text-muted pt-2 font-size-sm">Manage All Tags</div>
                        </h3>
                    </div>
                    <div class="card-toolbar">
                        ...
                        <a href="javascript::void(0)" class="btn btn-primary font-weight-bolder" data-toggle="modal" data-target="#exampleModalScrollable">
                            <span class="svg-icon svg-icon-md">
                                ...
                                <!--end::Svg Icon--></span> Add New Tags
                        </a>
                        <!--end::Button-->
                    </div>
                </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($r->status == 1)
                                    <div class="label label-lg label-success label-inline">Published</div>
                                    @else
                                    <div class="label label-lg label-danger label-inline">Pening</div>
                                    @endif 
                                </td>
                                <td nowrap="">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ url('admin/categories/deletetag') }}/{{ $r->id }}" class="btn btn-danger font-weight-bold">Yes, Delete it</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <h5 class="modal-title" id="exampleModalLabel">Update Tag: {{ $r->name }}</h5>
                                                </div>
                                            </div>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <i aria-hidden="true" class="ki ki-close"></i>
                                        ...
                                        <form enctype="multipart/form-data" method="POST" action="{{ url('admin/categories/updatetag') }}">
                                            @csrf
...
<div class="modal fade" id="exampleModalScrollable" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data" method="POST" action="{{ url('admin/categories/addnewtag') }}">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
