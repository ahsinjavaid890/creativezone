...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class=" container-fluid ">
            ...
            <form enctype="multipart/form-data" method="POST" action="{{ url('admin/routes/createroute') }}">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-3">
                                            <input type="text" id="autocomplete" class="form-control" placeholder="Enter your address" name="starting_point" required />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <label class="lable-control">Visiting Date</label>
                                        <div class="mb-3">
                                            <input type="date" name="visitng_date" class="form-control" placeholder="Enter Visiting Date" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="lable-control">Comments</label>
                                            <textarea placeholder="Comments" rows="4" class="summernote" name="comments" ></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
