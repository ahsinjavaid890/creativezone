                ...
                <div class="card-header flex-wrap"> 
                    ...
                    <div class="card-toolbar">
                        <a href="javascript:void(0)" data-toggle="modal" data-target="#exampleModalCenter" class="btn btn-primary font-weight-bolder">
                            <i class="ki ki-plus icon-1x mr-2"></i> Add New Modal
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Repair Category</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center pr-0">
                                   ...
                                   <a href="javascript:void(0);" onclick='confirmDelete("{{ url('admin/ecommerce/deletemodal') }}/{{ $r->id }}")' class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                      <span class="svg-icon svg-icon-md svg-icon-primary">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form enctype="multipart/form-data" method="POST" action="{{ url('admin/ecommerce/createmodal') }}" class="modal-content">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="category_id">
                                @foreach(DB::table('categories')->where('category_type' , 'repair')->where('status' , 1)->get() as $r)
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary font-weight-bold">Create New Modal</button>
            </div>
        </form>
    </div>
</div>
