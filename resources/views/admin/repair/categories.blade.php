            ...
            <div class="card card-custom mt-5">
                <div class="card-header flex-wrap">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{ url('admin/ecommerce/add-product-category') }}?category_type=repair" class="btn btn-primary font-weight-bolder">
                            Add New Category
                        </a>
                        <!--end::Button-->
                    </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center pr-0">
                                   <a href="javascript:void(0);" onclick='confirmstatus("{{ url('admin/ecommerce/changestatus') }}/{{ $r->id }}")' class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                   ...
                                   <a href="javascript:void(0);" onclick='confirmDelete("{{ url('admin/ecommerce/deleteproductcategories') }}/{{ $r->id }}")' class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                      <span class="svg-icon svg-icon-md svg-icon-primary">
