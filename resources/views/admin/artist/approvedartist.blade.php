            ...
            <div class="card card-custom mt-5">
                <div class="card-header flex-wrap">
                    <div class="card-title">
                        <h3 class="card-label">
                            Approved Artist
                            <div class="text-muted pt-2 font-size-sm">Manage Approved Artist</div>
                        </h3>
                    </div>
                </div>
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($r->status == 1)
                                    <div class="label label-lg label-success label-inline">Approved</div>
                                    @endif
                                </td>
                                <td nowrap="">
