            ...
            <div class="card card-custom mt-5">
                <div class="card-header flex-wrap">
                    <div class="card-title">
                        <h3 class="card-label">
                            Rejected Artist
                            <div class="text-muted pt-2 font-size-sm">Manage Rejected Artist</div>
                        </h3>
                    </div>
                </div>
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($r->status == 2)
                                    <div class="label label-lg label-danger label-inline">Rejeted</div>
                                    @endif
                                </td>
                                <td nowrap="">
