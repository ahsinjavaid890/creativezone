            ...
            <div class="col-lg-7 p-0">
                <div class="user-form-banner">
                    ...
                    <div class="user-form-content mt-4">
                        ...
                        <p>Log in to access your dashboard — manage your artwork listings, track your sales, engage with art lovers, and grow your presence in the region's leading artist marketplace.</p>
            ...
            <div class="col-lg-5 p-0">
                <div class="contact4-boxarea">
                    ...
                    <div class="" style="padding: 0px 50px;">
                        ...
                        <p class="text-anime-style-3 text-center">Log in to post an Event</p>
                        ...
                        <form method="POST" action="{{ url('artistlogin') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="input-area text-end">
                                        <button type="submit" style="width: 100%;" class="vl-btn1">Login</button>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 mt-4">
                                    <div class="user-form-direction">
                                        <p>Don't have an account? click on the <a href="{{ url('register') }}"><span>( sign up )</span></a> button.</p>
                                    </div>
                                </div>
                            </div>
                        </form>
